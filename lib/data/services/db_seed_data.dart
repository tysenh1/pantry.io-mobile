...
import '../database/app_database.dart'; // Ensure this matches your actual filename
...
Future<void> seedAllData(AppDatabase db) async {
  await db.transaction(() async {
    ...
    final pantrySeed = [
      ...
      {'name': 'Bun', 'qty': 0.0, 'unit': 'pcs', 'staple': false, 'gen': 'Bun'},
      {
      ...
      final id = await db
          ...
          .insert(
            PantryCompanion.insert(
              quantity: item['qty'] as Value<int>,
